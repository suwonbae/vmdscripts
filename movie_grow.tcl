vmd -dispdev text < movie_evol.tcl -args 0 grow
^[[?1;2cset blend [lindex $argv 0]
...
draw delete all
for {set i 0} {$i <= 10} {incr i $increment} {
	print $i
	animate goto $i
...
ffmpeg -an -i $savepath/$outfile.%4d.ppm -vcodec mpeg2video -r 11 -vframes 11 -vb 20M -filter:v "setpts=2.0*PTS
